document.addEventListener('DOMContentLoaded', () => {
    ...
    const vegetables = [
        "AI", "Camera", "CCTV", "Charger", "Computer-Mouse",
        "Earpod", "Headphone", "Internet-Cable", "Laptop", "Memory-Card",
        "Mobile", "Monitor", "Robot", "Satellite-Antenna", "Sim-Card",
        "Smart-Watch", "Solar-Pannel", "Speaker", "USB-Pendrive"
    ];
    let currentIndex = 0;
    let isDrawing = false;
    ...
    const imageBasePath = CDN + 'assets/images/electronics/';
    const audioBasePath = CDN + 'assets/audio/electronics/'; 
