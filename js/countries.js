document.addEventListener('DOMContentLoaded', () => {
    ...
    const vegetables = [
        "India", "China", "America", "Brazil", "Japan",
        "Africa", "Australia", "Canada", "Egypt", "France"
    ];
    let currentIndex = 0;
    let isDrawing = false;
    ...
    const imageBasePath = CDN + 'assets/images/country/';
    const audioBasePath = CDN + 'assets/audio/country/'; 
