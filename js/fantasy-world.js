document.addEventListener('DOMContentLoaded', () => {
    ...
    const vegetables = [
        "Alien", "Angel", "Devil", "Elf", "Fairy",
        "Pandora Box", "Santa", "Skull King", "Soul", "Vampire",
        "Witch"
    ];
    let currentIndex = 0;
    let isDrawing = false;
    ...
    const imageBasePath = CDN + 'assets/images/fiction/';
    const audioBasePath = CDN + 'assets/audio/fiction/'; 
