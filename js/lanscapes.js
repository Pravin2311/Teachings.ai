document.addEventListener('DOMContentLoaded', () => {
    ...
    const vegetables = [
        "AntHill", "Aurora", "Beach", "Camp", "Cave",
        "Desert", "EagleNest", "Forest", "Lake", "Mountain",
        "Ocean","River", "SunSet", "Volcano", "WaterFall"
    ];
    let currentIndex = 0;
    let isDrawing = false;
    ...
    const imageBasePath = CDN + 'assets/images/nature/';
    const audioBasePath = CDN + 'assets/audio/nature/'; 
