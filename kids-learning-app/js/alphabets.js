document.addEventListener('DOMContentLoaded', () => {
    ...
    const alphabets = Array.from({ length: 26 }, (_, i) => String.fromCharCode(65 + i)); // Letters A to Z
    let currentIndex = 0;
    let isDrawing = false;
    ...
    function updateLetterDisplay() {
        ...
        const imageSrc = imageBasePath + currentLetter + imageFormat;
        img.src = imageSrc;
        img.alt = 'Image for letter ' + currentLetter;
        ...
        img.onerror = () => {
            letterImageContainer.textContent = 'Image for ' + currentLetter + ' not found. Please add ' + currentLetter + imageFormat + ' to the assets/images/alphabets/ folder.';
    ...
    function playLetterAudio() {
        ...
        audio.play().catch(e => {
            console.error('Error playing audio for ' + currentLetter + ':', e);
        });
